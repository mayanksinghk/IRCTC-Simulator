...
# ============================================================
# WORKER FUNCTION (PROCESS GET REQUESTS)
# ============================================================
...
def main():
    parser = argparse.ArgumentParser(description="Parallel GET Request Grouper with IRCTC URI Normalization")
    parser.add_argument("-i", "--input", required=True, help="Input PCAP file")
    parser.add_argument("-o", "--out", default="get_request_summary.csv", help="Output CSV file")
