...
if __name__ == "__main__":
    ...
    plot_rtt_vs_counter(
        all_rtt, all_counter_png,
        title="All RTT vs Packet Counter",
        max_rtt_ms=args.max_rtt
    )
    ...
    plot_rtt_vs_counter(
        get_rtt, get_counter_png,
        title="GET RTT vs Packet Counter",
        max_rtt_ms=args.max_rtt
    )
    ...
    plot_rtt_vs_counter(
        post_rtt, post_counter_png,
        title="POST RTT vs Packet Counter",
        max_rtt_ms=args.max_rtt
    )
